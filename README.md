...
- **B** — объект (аббревиатура), **C** — полное название, **D** — ТН, **E** — ФИО, **F** и далее — дни.
- Верхняя строка листа — названия месяцев (ЯНВАРЬ, ФЕВРАЛЬ…); следующая — заголовки (ФИО, 1, 2, 3…); **F** = 1-е января. Парсер подстраивается под эту структуру.

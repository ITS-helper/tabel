...
3. Скрипт перезапишет **`scripts/parsed-employees-2026-h1.js`** (`PARSED_2026_1` … `PARSED_2026_6`). В **`app.js`** ключи **`2026-1`** … **`2026-6`** уже ссылаются на эти массивы; в **`index.html`** файл подключён перед **`app.js`**.
